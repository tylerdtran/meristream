    ...
    <main className="flex h-screen flex-col items-center justify-between">
      <NavBar />
        <div className="flex flex-col items-center justify-center h-full w-full">
          ...
          <Ellipse
            className="first-logo-circle"
          /> {/*top="385px"
  left="549px"*/}
            <Ellipse
            className="second-logo-circle"
          />
          <Ellipse
            className="third-logo-circle"
          />
          <Ellipse
            className="fourth-logo-circle"
          />
          <Ellipse 
            className="radial1-circle"
          />
          <Ellipse
            className="radial2-circle"
          />
          <Ellipse
            className="radial3-circle"
          />
